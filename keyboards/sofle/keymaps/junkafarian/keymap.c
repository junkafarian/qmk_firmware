 ...
 */
[_SYMBOL] = LAYOUT(
  _______, _______, _______, A(KC_3), _______, _______,                        KC_LCBR,   KC_RCBR,   KC_SLSH,   KC_7,  KC_8,  KC_9,
  ...
  _______,  KC_GRV, _______, _______, _______, A(KC_3), _______,       _______, KC_BSLS, KC_PIPE,   KC_MINS,   KC_0,  KC_0, KC_EQL,
