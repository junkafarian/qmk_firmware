 ...
 */
[_SYMBOL] = LAYOUT(
  _______, _______, _______, A(KC_3), C(G(KC_LEFT)), C(G(KC_RGHT)),            KC_LCBR,   KC_RCBR,   KC_SLSH,   KC_7,  KC_8,  KC_9,
  _______, _______, _______, _______, LCA(KC_LEFT), LCA(KC_RGHT),              KC_LBRC,   KC_RBRC,   KC_ASTR,   KC_4,  KC_5,  KC_6,
  _______, _______, _______, _______, LCA(KC_E), LCA(KC_G),                    KC_LPRN,   KC_RPRN,   KC_PLUS,   KC_1,  KC_2,  KC_3,
  _______,  KC_GRV, _______, _______, A(KC_3), G(KC_GRV), _______,       _______, KC_BSLS, KC_PIPE,   KC_MINS,   KC_0,  KC_0, KC_EQL,
